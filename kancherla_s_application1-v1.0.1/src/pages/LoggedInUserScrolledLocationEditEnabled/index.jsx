...
import LoggedInUserScrolledLocationEditEnabledRowfollow from "../../components/LoggedInUserScrolledLocationEditEnabledRowfollow";

const data = [
  { leisuretext: "Leisure", followbutton: "Follow" },
  { leisuretext: "Activism", followbutton: "Follow" },
  { leisuretext: "MBA", followbutton: "Follow" },
  { leisuretext: "Philosophy", followbutton: "Follow" },
];
...
export default function LoggedInUserScrolledLocationEditEnabledPage() {
  return (
    <>
      <Helmet>
        <title>User Dashboard | Explore ATG Groups</title>
        <meta
          name="description"
          content="Access your ATG dashboard to write posts, leave groups, and edit your location for a personalized experience. Discover events and job opportunities."
        />
      </Helmet>
      ...
      <div className="relative h-[1024px] w-full bg-white-A700 md:h-auto">
                  ...
                  <div className="flex w-[94%] md:w-full md:p-5">
                    <div className="flex w-full flex-col items-start">
                      ...
                      <div className="mt-[29px] flex items-center justify-between gap-5 self-stretch">
                        ...
                        <div className="flex w-[27%] items-center justify-between gap-5">
                          <div className="flex items-center gap-2">
                            <Img src="images/img_eye.svg" alt="education views icon" className="h-[18px] w-[18px]" />
                            <Text as="p" className="!font-medium !text-blue_gray-700">
                              1.4k views
                            </Text>
                          </div>
                      ...
                      <div className="mt-3 flex items-center gap-10 self-stretch md:flex-col">
                        <div className="flex flex-1 items-center justify-between gap-5 md:self-stretch">
                          ...
                          <div className="flex gap-2">
                            <Img src="images/img_eye.svg" alt="meetup views icon" className="h-[18px] w-[18px]" />
                            <Text as="p" className="!font-medium !text-blue_gray-700">
                              1.4k views
                            </Text>
                          </div>
                ...
                <div className="absolute bottom-[0.00px] left-0 right-0 m-auto w-full rounded border border-solid border-gray-300 bg-white-A700 p-5">
                  <div className="flex flex-col items-start">
                    ...
                    <div className="mt-8 flex items-center justify-between gap-5 self-stretch">
                      ...
                      <div className="flex w-[27%] items-center justify-between gap-5">
                        <div className="flex gap-2">
                          <Img src="images/img_eye.svg" alt="job views icon" className="h-[18px] w-[18px]" />
                          <Text as="p" className="!font-medium !text-blue_gray-700">
                            1.4k views
                          </Text>
                        </div>
                  ...
                  <div className="flex w-[94%] flex-col items-start md:w-full md:p-5">
                    ...
                    <div className="mt-8 flex items-center justify-between gap-5 self-stretch">
                      <div className="flex w-[25%] items-center justify-center gap-2.5">
                        <Img
                          src="images/img_rectangle_3_1.png"
                          alt="second organizer image"
                          className="h-[48px] w-[48px] rounded-[50%]"
                        />
                        <Heading as="h6">Ronal Jones</Heading>
                      </div>
                      <div className="flex gap-2">
                        <Img src="images/img_eye.svg" alt="second meetup views icon" className="h-[18px] w-[18px]" />
                        <Text as="p" className="!font-medium !text-blue_gray-700">
                          1.4k views
                        </Text>
                      </div>
        ...
        <div className="absolute right-[14%] top-[19%] m-auto flex w-[17%] flex-col items-end">
          ...
          <div className="mt-[31px] flex items-start gap-[7px] self-stretch">
          ...
          <div className="mt-[53px] flex flex-col gap-[23px] self-stretch">
            <div className="flex items-center gap-1">
              <Img src="images/img_twotone_thumb_up_24px.svg" alt="thumbs up icon" className="h-[18px] w-[18px]" />
              <Text as="p" className="uppercase tracking-[1.40px]">
                REcommended Groups
              </Text>
            </div>
            <div className="flex flex-col gap-[22px]">
              {data.map((d, index) => (
                <LoggedInUserScrolledLocationEditEnabledRowfollow {...d} key={"groupsList" + index} />
              ))}
            </div>
          </div>
          <Text size="s" as="p" className="mt-[54px] !text-blue-A700">
            See More...
          </Text>
        </div>
      </div>
